...
export function GeneralPane() {
  ...
  return (
    <div className="stack">
      <WorkspaceCard editable={editable} onRename={(name) => rename.mutateAsync(name)} />
    ...
    <div className="card">
      ...
      <div className="setrow">
        ...
        <div className="controls">
          <input type="text" value={name} disabled={!editable} onChange={(e) => setName(e.target.value)} />
          {editable && <button className="btn" onClick={save}>Save</button>}
        </div>
      </div>
      <div className="setrow">
        <div>
...
function LinkLimitsCard({ editable, limits, rateCard, onSave }: {
  ...
  return (
    <div className="card">
      ...
      <p className="sub">
        Guardrails for every link a chatter creates. The fixed fee makes small tickets
...
function EnableTwoFactorModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <Modal open onClose={onClose}>
      ...
      <p className="sub">
        Add a new account in your authenticator app using this setup key or link, then enter the
    ...
    <div className="card">
      ...
      <div className="setrow">
        ...
        <div className="controls">
          ...
          <select disabled={tzMode === 'auto'} value={activeZone}
