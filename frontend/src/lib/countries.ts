// ISO 3166-1 alpha-2. The codes are the data — the database column is two
// letters — and the names come from the browser, so this never becomes a
...
/** The country's name, or the code itself where the browser has no name. */
...
/** Every country, by name, for a picker. */
